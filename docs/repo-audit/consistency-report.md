...
**Canonical:** CerbaSeal v0.1.0 is **pilot-ready**. The enforcement core is production-quality (419 passing tests, adversarial-validated, cryptographically chained audit), but the product is in active pilot delivery, not general availability.
