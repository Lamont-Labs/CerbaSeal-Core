...
> "That's completely understandable, and it's something we're transparent about. A formal third-party security review hasn't been completed. The enforcement core has gone through rigorous internal adversarial testing — 415 tests including bypass attempts, forgery scenarios, and boundary probes — but that's not the same as an independent external review.
