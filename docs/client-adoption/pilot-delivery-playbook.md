...
1. Clone repository
2. `pnpm install`
3. `pnpm test` — confirm 432/432 passing
...
**Week 2 Gate:** All checks pass (432 tests, 15/15 audit, proof verified). Three test scenarios confirmed. Client technical owner operating independently.
