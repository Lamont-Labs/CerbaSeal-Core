...
**Total: 419 passing. 0 failing. 17 test files.**
...
- `.github/workflows/audit.yml` — full pipeline: TypeScript check, 419 tests, import boundary check, invariant coverage, 16/16 audit checks, proof export, proof verify, snapshot upload as artifact with 90-day retention
