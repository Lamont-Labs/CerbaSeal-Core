export const REVIEW_SUMMARY = {
    ...
    definition: "CerbaSeal is a deterministic execution enforcement spine for AI-assisted workflows. It sits between a decision system and an execution system, returning ALLOW, HOLD, or REJECT with a hash-linked evidence trail.",
    implemented: [
    ...
    demoScenarios: [
        {
            ...
            plainMeaning: "An AI actor with an AI-sourced proposal cannot authorize execution. CerbaSeal blocks unconditionally.",
        },
        {
            id: "hold",
            ...
            plainMeaning: "The request is structurally valid but required approval is absent. Execution is paused, not rejected.",
        },
        {
            id: "allow",
            ...
            plainMeaning: "All required conditions are satisfied. A release authorization is issued and the action may execute.",
        },
    ],
    testStatus: {
        reportedPassing: 372,
    ...
    limitationNotice: "This is a review-ready core demo, not a production client deployment.",
};
export const PILOT_READINESS = {
    ...
    recommendedFirstPilotShape: {
        ...
        description: "One client, one workflow, one decision path, one approval model, one verifiable outcome.",
    },
    ...
    implementedControls: [
        {
            ...
            invariant: "INV-05",
            description: "AI actor with AI-sourced proposal cannot produce authority-bearing action under any condition",
        },
        {
            control: "Approval artifact binding",
            invariant: "INV-03 / Fix 1",
            description: "approvalArtifact.forRequestId must exactly equal request.requestId — prevents cross-request reuse",
        },
        {
            control: "Workflow-level approval enforcement",
            invariant: "INV-03 / Fix 2",
            description: "fraud_triage workflow always requires approval at gate level — callers cannot opt out",
        },
        {
            control: "Gate issuance registry",
            invariant: "INV-06 / Fix 3",
            description: "Module-private WeakSet; EvidenceBundleService rejects any GateResult not from evaluate()",
        },
        {
            control: "Fail-closed catch-all",
            invariant: "Fix 6",
            description: "All unexpected errors produce controlled REJECT — no silent success on exception",
        },
        {
        ...
        },
        {
            ...
            invariant: "INV-02",
            description: "provenanceRef required with non-empty modelVersion, ruleSetVersion, sourceHash",
        },
        {
        ...
        },
        {
            ...
            invariant: "INV-08",
            description: "sensitive=true: criticalControlsValid must be true AND stale must be false",
        },
        {
