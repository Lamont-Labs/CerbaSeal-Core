...
const WORKFLOWS_REQUIRING_APPROVAL = new Set(["fraud_triage"]);
...
const _gateIssuedResults = new WeakSet();
export function assertIsGateIssued(result) {
...
function assertApprovalState(request, invariantChecks) {
    ...
    const effectiveApprovalRequired = request.approvalRequired || WORKFLOWS_REQUIRING_APPROVAL.has(request.workflowClass);
