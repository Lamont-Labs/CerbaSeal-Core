...
import { buildSupportRejectScenario, buildSupportHoldScenario, buildSupportAllowScenario } from "../../src/services/support/support-fixtures.js";
...
describe("Operator Action Service", () => {
    ...
    it("MALFORMED_REQUEST rejection produces correction recommendation", () => {
        ...
        const result = gate.evaluate({ ...base, requestId: "" });
...
describe("System Integrity Verification", () => {
    ...
    it("repeatability checks are included and pass", () => {
        const result = runSystemIntegrityVerification();
        const repeatChecks = result.checks.filter((c) => c.name.includes("repeatability"));
