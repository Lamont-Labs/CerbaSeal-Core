...
function cover(): void {
  ...
  doc.y = 222;
  statBoxes([
    { label: "TEST SUITE", value: "391/391", sub: "16 test files · zero regressions", color: C.green },
...
// ═══════════════════════════════════════════════════════════════════════════
function sec9(): void {
  sectionBar("9", "Test Suite — 16 Files, 391 Tests");
...
function sec10(): void {
  ...
  table(
    ...
    [
      ["1", "Full test suite passes", "Runs pnpm test — expects all 391 tests to pass with zero failures"],
...
function sec15(): void {
  ...
  const tree: TreeEntry[] = [
    ...
    { type: "file", path: "  README.md", desc: "Full public README with system overview, adoption layer section, 391 test count" },
